...
namespace SharpPcap.Packets
{
    ...
    public struct ICMPMessages_Fields
    {
        ...
        /// <summary> Communication prohibited.</summary>
        public readonly static int COMMUNICATION_PROHIB = 0x030d;
        ...
        public readonly static int TIME_EXCEED_IN_TRANS = 0x0B00;
        /// <summary> time exceeded in reass.</summary>
        public readonly static int TIME_EXCEED_REASS = 0x0B01;
        /// <summary> ip header bad: pointer indicates the error.</summary>
        public readonly static int PARAM_PROB_POINTER = 0x0C00;
        /// <summary> ip header bad: option absent.</summary>
        public readonly static int PARAM_PROB_OPTION_ABSENT = 0x0C01;
        /// <summary> ip header bad: bad length.</summary>
        public readonly static int PARAM_PROB_BAD_LEN = 0x0C02;
