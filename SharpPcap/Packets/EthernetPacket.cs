...
namespace SharpPcap.Packets
{
    ...
    public class EthernetPacket : Packet, EthernetFields
    {
        ...
        virtual public byte[] EthernetHeader
        {
            ...
            {
                Array.Copy(value, 0, _bytes, 0, EthernetHeaderLength);
            }
        }
        ...
        /// recognized as a protocol for which a class exists in the network library, 
        ...
        /// <summary> Fetch the MAC address of the destination host.</summary>
        ...
        public override System.String ToColoredString(bool colored)
        {
            ...
            buffer.Append(" l=" + EthernetHeaderLength);
            buffer.Append(']');
