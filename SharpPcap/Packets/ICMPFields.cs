...
namespace SharpPcap.Packets
{
    ...
    public struct ICMPFields_Fields
    {
        ...
        /// <summary> Length of the ICMP header identifier in bytes.</summary>
        public readonly static int ICMP_ID_LEN = 2;
        /// <summary> Length of the ICMP header sequence number in bytes.</summary>
        public readonly static int ICMP_SEQ_LEN = 2;
        ...
        /// <summary> Position of the ICMP identifier.</summary>
        public readonly static int ICMP_ID_POS;
        /// <summary> Position of the ICMP sequence number.</summary>
        public readonly static int ICMP_SEQ_POS;
        ...
        static ICMPFields_Fields()
        {
            ...
            ICMP_CSUM_POS = ICMPFields_Fields.ICMP_SUBC_POS + ICMPFields_Fields.ICMP_SUBC_LEN;
            ICMP_ID_POS = ICMPFields_Fields.ICMP_CSUM_POS + ICMPFields_Fields.ICMP_CSUM_LEN;
            ICMP_SEQ_POS = ICMPFields_Fields.ICMP_ID_POS + ICMPFields_Fields.ICMP_ID_LEN;
