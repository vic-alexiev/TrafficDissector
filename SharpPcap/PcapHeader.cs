...
namespace SharpPcap
{
    ...
    public class PcapHeader
    {
        ...
        internal PcapHeader(IntPtr pcap_pkthdr)
        {
            ...
            {
                PcapUnmanagedStructures.pcap_pkthdr_unix pkthdr =
                    (PcapUnmanagedStructures.pcap_pkthdr_unix)Marshal.PtrToStructure(pcap_pkthdr,
            ...
            {
                PcapUnmanagedStructures.pcap_pkthdr_windows pkthdr =
                    (PcapUnmanagedStructures.pcap_pkthdr_windows)Marshal.PtrToStructure(pcap_pkthdr,
